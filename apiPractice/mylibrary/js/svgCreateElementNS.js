...
//  .emoji { position: absolute; width: 500%; height: 500%; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: -1; }

// <svg class="emoji" viewBox="0 0 500 500"></svg>
 
let container = document.querySelector(".write-btn-wrap");
let svg = container.querySelector(".emoji");
